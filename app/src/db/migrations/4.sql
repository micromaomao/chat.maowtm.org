...
alter table chat_reply_metadata alter column matched_phrasings to __deleted_matched_phrasings;
alter table chat_reply_metadata alter column match_scores to __deleted_match_scores;
alter table chat_reply_metadata alter column best_match_dialogue to __deleted_best_match_dialogue;
